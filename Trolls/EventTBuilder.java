...
/**
 * This class is used to build EventTroll objects.
 */
public class EventTBuilder implements TrollBuilder {
     ...
     */
    public EventTroll getResult(Player player) {
        return new EventTroll(player);
    }
}
